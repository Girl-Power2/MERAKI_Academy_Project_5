      ...
      <MDBRow>
        ...
        <MDBCol sm='6'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
            ...
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Password' id='formControlLg' type='password' size="lg" onChange={(e)=>{
        ...
        localStorage.setItem("providerId", result.data.providerId);
        ...
        <MDBCol sm='6' className='d-none d-sm-block px-0'>
          <img src=".\img\Lifesavers - One on One.png"
